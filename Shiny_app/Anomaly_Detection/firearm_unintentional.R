...
##HEAT RELATED SURVIELLANCE##
# ── 1. Load & Prepare datsets ─────────────────────
...
ed_raw  <- load_dataset(
  "C:/Users/mdickson/OneDrive - Metro Nashville Gov/Desktop/CVS_Files/firearm_2226.csv",
  "Date", "Zipcode", "ED"
)
...
ui <- fluidPage(
  ...
  div(class = "dash-header",
      div(
        div(class = "subtitle", "Unintentional Firearm Injury Surveillance System"),
