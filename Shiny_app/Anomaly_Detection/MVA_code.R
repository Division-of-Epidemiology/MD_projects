...
load_dataset <- function(path, date_col, label) {
  df <- read.csv(path)
...
ed_data  <- load_dataset(
  "C:/Users/mdickson/OneDrive - Metro Nashville Gov/Desktop/CVS_Files/ESS_MVA_2526.csv",
  "Date", "ED"
)

me_data  <- load_dataset(
  "C:/Users/mdickson/OneDrive - Metro Nashville Gov/Desktop/CVS_Files/MVA_2326.csv",
  "DOD", "ME"
)

dataset_list <- list(
  "ED — Emergency Department"         = ed_data,
  "ME — Medical Examiner"             = me_data
)
...
ui <- fluidPage(
  ...
  div(class = "dash-header",
      div(
        div(class = "subtitle", "Motor Vehicle Accident Surveillance System"),
