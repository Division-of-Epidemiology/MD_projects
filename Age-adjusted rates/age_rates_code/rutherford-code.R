##Setting up the packages for calculating Age-adjusted rates for OD's 2020-2023 for Rutherford Co
...
population_23 <- c(21092,	21667,	23526,	23263,	29944,	48070,	45720,	41996,	34798,	21370,	9486,	3207)
population_22 <- c(21092,	21667,	23526,	23263,	29944,	48070,	45720,	41996,	34798,	21370,	9486,	3207)
population_21 <- c(21092,	21667,	23526,	23263,	29944,	48070,	45720,	41996,	34798,	21370,	9486,	3207)
population_20 <- c(21092,	21667,	23526,	23263,	29944,	48070,	45720,	41996,	34798,	21370,	9486,	3207)

#Setting the deaths in each population 
deaths_23 <- c(0,	0,	0,	3,	5,	24,	26,	24,	9,	2,	0,	0)
deaths_22 <- c(0,	0,	0,	3,	6,	27,	28,	27,	12,	0,	0,	0)
deaths_21 <- c(0,	0,	0,	5,	9,	45,	28,	26,	13,	5,	1,	0)
deaths_20 <- c(1,	0, 0,	5,	10,	32,	24,	20,	9,	3,	0,	0)
