##Setting up the packages for calculating Age-adjusted rates for OD's 2020-2023 for Montgomery Co
...
population_23 <- c(17118,	15471,	14457,	13105,	17475,	38987,	27488,	22305,	19521, 11923,	5065,	2077)
population_22 <- c(17118,	15471,	14457,	13105,	17475,	38987,	27488,	22305,	19521, 11923,	5065,	2077)
population_21 <- c(17118,	15471,	14457,	13105,	17475,	38987,	27488,	22305,	19521, 11923,	5065,	2077)
population_20 <- c(17118,	15471,	14457,	13105,	17475,	38987,	27488,	22305,	19521, 11923,	5065,	2077)

#Setting the deaths in each population 
deaths_23 <- c(0,	0,	0,	1,	3,	15,	25,	16,	9,	0,	0,	0)
deaths_22 <- c(0,	0,	0,	1,	3,	16,	26,	16,	7,	0,	0,	0)
deaths_21 <- c(0,	0,	0,	1,	11,	30,	22,	24,	13,	0,	0,	0)
deaths_20 <- c(0,	0, 0,	1,	3,	21,	26,	19,	9,	0,	0,	0)
